...
Traefik static config schema is from: https://json.schemastore.org/traefik-v3.json

Traefik dynamic config schema is from: https://json.schemastore.org/traefik-v3-file-provider.json
